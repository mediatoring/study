...
Datová a analytická cvičení pro kurzy a workshopy. Každé cvičení má vlastní složku se zadáním, data visí u příslušného release.

## Cvičení

| Cvičení | O čem to je | Obtížnost | Data |
|---|---|---|---|
| 1. [Prodejní data PAPYRA Industry](exercises/prodeje-papyra/) | Milion řádků fakturace tak, jak vypadla ze systému. Jednatřicet otázek od prvního
součtu po shrnutí pro vedení a příběh, který si poskládáš sám. | střední | [74.7 MB](https://github.com/mediatoring/study/releases/tag/prodeje-papyra-v1) |
...
Zadání i data jsou k dispozici pod [CC BY 4.0](LICENSE). Data jsou syntetická, žádný reálný subjekt za nimi nestojí.
