...
Čtyři pohledy, které se do měsíčního reportu nevejdou: co se kupuje spolu, kdo platí kolik, na kom visí které výrobky a proč se dva závody nedají srovnat.

**Obtížnost:** těžká · **Časová náročnost:** 6-8 hodin · **Nástroje:** Python, R, SQL, DuckDB · **Témata:** analýza nákupního košíku, cenová analytika, koncentrace sortimentu, srovnatelnost ukazatelů
